...
*/
{
    ...
    class ImageTrail {
        constructor() {
            // images container
            this.DOM = {content: document.querySelector('.c-trail__content')};
        ...
        showNextImage() {
            ...
            .to(img.DOM.el, 1, {
                ...
                y: `+=${winsize.height + img.rect.height+200}`
            }, 0.4);
        }
    }
    ...
    const preloadImages = () => {
        return new Promise((resolve, reject) => {
            imagesLoaded(document.querySelectorAll('.c-trail__img'), resolve);
        });
    };
